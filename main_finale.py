...
for size in range(1000,1001):
    ...
    for iterations in range(0,10):
        ...
        init_Segment_time.append((end_time_init_seg - start_time_init_seg)*1000)
        ...
        update_Segment.append((end_time_upd_seg - start_time_upd_seg)*1000)
        ...
        sum_Segment.append((end_time_sum_seg - start_time_sum_seg)*1000)
        ...
        min_Segment.append((end_time_min_seg - start_time_min_seg)*1000)
        ...
        max_Segment.append((end_time_max_seg - start_time_max_seg)*1000)
        ...
        value_to_count = random.randint(1, int(size*100))
        ...
        count_segment.append((end_time_cnt_seg - start_time_cnt_seg)*1000)
        ...
        init_Fen_time.append((end_time_init_fen- start_time_init_fen)*1000)
        ...
        update_Fen.append((end_time_upd_fen - start_time_upd_fen)*1000)
        ...
        sum_Fen.append((end_time_sum_fen - start_time_sum_fen)*1000)
        ...
        init_Treap_time.append((end_time_init_trp - start_time_init_trp)*1000)
        ...
        update_Treap.append((end_time_upd_trp - start_time_upd_trp)*1000)
        ...
        sum_Treap.append((end_time_sum_trp - start_time_sum_trp)*1000)
        ...
        min_Treap.append((end_time_min_trp - start_time_min_trp)*1000)
        ...
        max_Treap.append((end_time_max_trp - start_time_max_trp)*1000)
        ...
        count_Treap.append((end_time_cnt_trp - start_time_cnt_trp)*1000)
    ...
    dp = pandas.DataFrame(antidp, index=["Init", "Init Memory", "Update", "Sum", "Min", "Max", "Count"],
                          columns=["Segment", "Fenwick", "Treap"])
    all_store.append(dp)




with pandas.ExcelWriter('Result_1000.xlsx') as writer:
    for i in range(len(all_store)):
        all_store[i].to_excel(writer, sheet_name=f'1000_{i+10}')
